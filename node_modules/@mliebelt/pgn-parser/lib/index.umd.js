	...
	(function (module) {
		...
		(function (root, factory) {
		    ...
		    function peg$parse(input, options) {
		        ...
		        var peg$f115 = function (cf, cfl) { var arr = []; arr.push(cf); for (var i = 0; i < cfl.length; i++) {
		            arr.push(cfl[i][2]);
		        } return arr; };
		        var peg$f116 = function (col, f) { return col + f; };
		        var peg$f117 = function (cf, cfl) { var arr = []; arr.push(cf); for (var i = 0; i < cfl.length; i++) {
		            arr.push(cfl[i][2]);
		        } return arr; };
